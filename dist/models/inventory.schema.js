...
import { ConsumptionUnit, PackType, } from "../types/inventory.js";
...
inventorySchema.virtual("availablePacks").get(function () {
...
// UI helper
inventorySchema.virtual("availableDisplay").get(function () {
...
inventorySchema.statics.findByProductAndBatch = function (shopId, productId, batchNumber) {
    return this.findOne({ shopId, productId, batchNumber });
};
inventorySchema.statics.hasSufficientStock = async function (inventoryId, requiredPacks) {
